local Configs_HUB = {
  Cor_Hub = Color3.fromRGB(10, 10, 10),       -- Fundo principal
  Cor_Options = Color3.fromRGB(25, 25, 25),   -- Segunda camada
  Cor_Stroke = Color3.fromRGB(180, 0, 0),     -- Bordas
  Cor_Text = Color3.fromRGB(255, 0, 0),       -- Texto principal
  Cor_DarkText = Color3.fromRGB(200, 0, 0),   -- Texto secundário
